...
# ---------------------------------------------------------
# 목적
# - 기존 Yahoo earningsTrend 기반 EPS revision Stage1 제거
# - 기대 상향 프록시(expectation upgrade proxy) 기반 Stage1 재구성
# - 시장 레짐 절대 컷 제거
# - 최소 가격 / 시총 / 거래대금 필터 유지
# - 기존 출력 파일명 유지
#
# 철학
# - 직접적인 analyst revision 관측이 아니라
#   "앞으로 기대치 상향이 뒤따를 가능성이 높은 숫자 구조"를 먼저 탐지
# - 숫자 + 질 + 가격 선반응 + 구조를 묶어 Stage1 구성
# =========================================================
...
def compute_expectation_upgrade_proxy(
    ...
    # structure / expectation confirmation
    structure_score = 0.0
